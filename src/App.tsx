        ...
        <div id="tech" className={styles.tech_stack}>
          ...
          <div id="projects" className={styles.projects}>
            ...
            <div className={styles.project_cards}>
              <ProjectCard title="Jobs Scrapper" description="Solution to scrape jobs from a website and save them to a database." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/jobs_scraper" technologies="Python, Firebase" />
              <ProjectCard title="Learning Styles" description="App created to help students identify their learning styles and improve their learning process." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/assist_app" technologies="React, JavaScript" />
              <ProjectCard title="Bakery Website" description="Website created for a bakery to showcase their products and services." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/wdd130/tree/master/idaho-bakery" technologies="HTML, CSS, JavaScript" />
              <ProjectCard title="Food Menu" description="Backend for a food menu created for a restaurant to showcase their products." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/menu" technologies="Java, Spring Boot, PostgreSQL" />
              <ProjectCard title="Application Tracker" description="University Applications CRM to track all events, status with students." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/menu" technologies="NodeJS, NextJS, Firebase" />
            </div>
          </div>
        </div>
      </div>
