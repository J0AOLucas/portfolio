      ...
      <div className={styles.home}>
        ...
        <div id="tech" className={styles.tech_stack}>
          ...
          <div className={styles.tech_logos}>
            <img src={new URL('./assets/icons/html-logo.svg', import.meta.url).toString()} alt="html logo" />
            <img src={new URL('./assets/icons/css-logo.svg', import.meta.url).toString()} alt="css logo" />
            <img src={new URL('./assets/icons/js-logo.svg', import.meta.url).toString()} alt="js logo" />
            <img src={new URL('./assets/icons/react-logo.svg', import.meta.url).toString()} alt="react logo" />
            ...
            <div>
              ...
              <img src={new URL('./assets/icons/postgres-logo.svg', import.meta.url).toString()} alt="postgres logo" />
              <img src={new URL('./assets/icons/github-logo.svg', import.meta.url).toString()} alt="github logo" />
            </div>
          </div>
          ...
          <div id="projects" className={styles.projects}>
            ...
            <div className={styles.project_cards}>
              <ProjectCard title="Jobs Scrapper" description="Solution to scrape jobs from a website and save them to a database." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/jobs_scraper" live_link="https://www.google.com" technologies="Python, Firebase" />
              <ProjectCard title="Learning Styles" description="App created to help students identify their learning styles and improve their learning process." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/assist_app" live_link="https://www.google.com" technologies="React, JavaScript" />
              <ProjectCard title="Bakery Website" description="Website created for a bakery to showcase their products and services." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/wdd130/tree/master/idaho-bakery" live_link="https://www.google.com" technologies="HTML, CSS, JavaScript" />
              <ProjectCard title="Food Menu" description="Backend for a food menu created for a restaurant to showcase their products." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/menu" live_link="https://www.google.com" technologies="Java, Spring Boot, PostgreSQL" />
              <ProjectCard title="Application Tracker" description="University Applications CRM to track all events, status with students." image={new URL('./assets/images/project-background.png', import.meta.url).toString()} link="https://github.com/J0AOLucas/menu" live_link="https://www.google.com" technologies="NodeJS, NextJS, Firebase" />
            </div>
          </div>
        </div>
      </div>
